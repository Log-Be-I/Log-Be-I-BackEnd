...
import com.springboot.question.entity.Question.QuestionAnswerStatus;
import com.springboot.question.entity.Question.QuestionStatus;
...
class QuestionServiceTest {
    ...
    void createQuestion_shouldReturnSavedQuestion() {
        ...
        question.setMember(new com.springboot.member.entity.Member());
    ...
    void findQuestions_shouldReturnFilteredQuestions() {
        ...
        q1.setTitle("Java");
        q1.setMember(member);
        q1.setQuestionStatus(QuestionStatus.QUESTION_REGISTERED);
    ...
    void findMyQuestions_shouldReturnQuestionsSortedByCreatedAt() {
        ...
        when(memberService.findVerifiedExistsMember(anyLong())).thenReturn(new com.springboot.member.entity.Member());
    ...
    void findQuestion_shouldReturnIfAuthorized() {
        ...
        question.setQuestionStatus(QuestionStatus.QUESTION_REGISTERED);
    ...
    void deleteQuestion_shouldChangeStatus() {
        ...
        verify(questionRepository).save(question);
        assertThat(question.getQuestionStatus()).isEqualTo(QuestionStatus.QUESTION_DELETED);
    }
    ...
    void isAnswered_shouldThrowIfAnswered() {
        Question question = new Question();
        question.setQuestionAnswerStatus(QuestionAnswerStatus.DONE_ANSWER);
