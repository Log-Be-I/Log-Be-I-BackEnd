...
import com.logbei.be.auth.filter.JwtAuthenticationFilter;
...
import com.logbei.be.oauth.OAuthAuthenticationFilter;
import com.logbei.be.oauth.OAuthAuthenticationProvider;
...
//        configuration.setAllowedOrigins(Arrays.asList("*"));
        ...
        configuration.setAllowedOrigins(List.of(
                "https://web.logbe-i.com", // 정확한 도메인
                "http://localhost:3000", // 포트까지 명시
